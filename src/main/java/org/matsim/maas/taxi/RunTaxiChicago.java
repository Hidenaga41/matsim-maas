...
public class RunTaxiChicago {
	public static final String CONFIG_FILE_RULEBASED = "scenarios/mielec_2014_02/mielec_taxi_config_rulebased.xml";
//	public static final String CONFIG_FILE_ASSIGNMENT = "scenarios/chicago/chicago_taxi_config_assignment.xml";
	public static final String CONFIG_FILE_ASSIGNMENT = "scenarios/Chicago190701/chicago_taxi_config_assignment.xml";
...
//		RunTaxiExample.run(CONFIG_FILE_RULEBASED,false, 10); // switch to 'true' to turn on visualisation
		RunTaxiChicago.run(CONFIG_FILE_ASSIGNMENT, false, 0); // switch to 'true' to turn on visualisation
	}
}
